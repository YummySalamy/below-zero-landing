...
export default function SuccessCases() {
  ...
  const successCases = [
    {
      ...
      images: [
        "/commercial-rooftop-hvac-unit-aaon.jpg",
        "/high-rise-building-project-view.jpg",
        "/large-scale-rooftop-hvac-installation-gravel.jpg",
      ],
      category: "Commercial",
      year: "2024",
    },
    {
      ...
      images: [
        "/rooftop-condenser-units-residential-complex.jpg",
        "/jersey-city-project-view-bowie-mural.jpg",
        "/service-van-interior-storage.jpg",
      ],
      category: "Commercial",
      year: "2023",
    },
    {
      ...
      images: [
        "/triplex-booster-pump-system-skid.jpg",
        "/industrial-pump-control-panel-wilo.jpg",
        "/armstrong-vertical-inline-pumps-red.jpg",
      ],
      category: "Industrial",
      year: "2023",
    },
    {
      ...
      images: [
        "/blue-backflow-preventer-valves-piping.jpg",
        "/armstrong-vertical-inline-pumps-red.jpg",
        "/industrial-pump-control-panel-wilo.jpg",
      ],
    ...
    },
    {
      ...
      images: [
        "/images/lochinvar-boilers-main.jpeg",
        "/images/technician-boiler.jpeg",
        "/images/mechanical-room-pipes.jpeg",
        "/images/lochinvar-boilers-side.jpeg",
        "/images/large-tank-pipes.jpeg",
        "/images/lochinvar-boilers-front.jpeg",
      ],
    ...
    },
    {
      ...
      images: ["/images/rooftop-hvac-unit.jpeg", "/images/rooftop-vent.jpeg", "/images/elevator-lobby-ac.jpeg"],
      category: "Commercial",
      year: "2023",
    },
    {
      id: 7,
      title: t("successCases.case7.title"),
      client: t("successCases.case7.client"),
      description: t("successCases.case7.description"),
      results: [t("successCases.case7.result1"), t("successCases.case7.result2"), t("successCases.case7.result3")],
      images: [
        "/revent-industrial-ovens.jpg",
        "/industrial-bakery-ventilation.jpg",
        "/technician-installing-venting.jpg",
      ],
      category: "Hospitality",
      year: "2024",
    },
    {
      id: 8,
      title: t("successCases.case8.title"),
      client: t("successCases.case8.client"),
      description: t("successCases.case8.description"),
      results: [t("successCases.case8.result1"), t("successCases.case8.result2"), t("successCases.case8.result3")],
      images: [
        "/raypak-boiler-installation.jpg",
        "/vertical-industrial-pumps.jpg",
        "/blue-valve-manifold-system.jpg",
        "/abb-hvac-control-panel.jpg",
        "/rooftop-hvac-city-view.jpg",
      ],
      category: "Industrial",
      year: "2024",
    },
  ...
  const categories = [
    ...
    { key: "Residential", label: t("successCases.category.residential") },
    { key: "Mixed Use", label: t("successCases.category.mixeduse") },
  ]
